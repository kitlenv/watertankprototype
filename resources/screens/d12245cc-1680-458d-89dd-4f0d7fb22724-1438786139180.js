...
"action": "jimShow",
"parameter": {
"target": "#s-Group_Personal_Producer_Food"
},
"exectype": "serial",
"delay": 0
}
...
"action": "jimShow",
"parameter": {
"target": "#s-Group_Personal_Producer_Coffee"
},
"exectype": "serial",
"delay": 0
}
...
.on("pinchopen", ".s-d12245cc-1680-458d-89dd-4f0d7fb22724 .pinchopen", function(event, data) {
var jEvent, jFirer, cases;
if(data === undefined) { data = event; }
jEvent = jimEvent(event);
jFirer = jEvent.getEventFirer();
...
"action": "jimNavigation",
"parameter": {
"target": "screens/1d493b96-2048-487e-8f59-400f43f1cf0d"
},
"exectype": "serial",
"delay": 0
}
